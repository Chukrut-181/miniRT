...
/*   Updated: 2025/02/25 11:54:16 by igchurru         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_submatrix_3x3(t_4x4 *matrix, t_3x3 *submatrix, int exclude_col)
{
	int	row;
	int	i;
	int	col_offset;
...
float	ft_calculate_determinant(t_4x4 *matrix)
{
	...
	while (col < 4)
	{
		get_submatrix_3x3(matrix, &submatrix, col);
